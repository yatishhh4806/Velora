        ...
        <div className="mb-6">
            ...
            {sizes.map((size) => (
                <div key={size} className="flex items-center mb-1">
                    <input type="checkbox" name='size' className="mr-2 h-3 w-3 text-blue-500 focus:ring-blue-400 border-gray-300" />
        ...
        <div className="mb-6">
            ...
            {materials.map((material) => (
                <div key={material} className="flex items-center mb-1">
                    <input type="checkbox" name='material' className="mr-2 h-3 w-3 text-blue-500 focus:ring-blue-400 border-gray-300" />
